...
router.post('/database-version', (req, res) => {
  void CSQLServerV1.databaseVersion(req, res);
});
...
router.get('/diagram/schema', (req, res) => {
  void CSQLServerV1.schemaDiagram(req, res);
});
router.get('/diagram/object/:tableName', (req, res) => {
  void CSQLServerV1.objectDiagram(req, res);
});
router.get('/procedure-ddl/:procedureName', (req, res) => {
  void CSQLServerV1.procedureDDL(req, res);
});
