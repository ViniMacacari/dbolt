...
router.post('/database-version', (req, res) => {
  void CPostgresV1.databaseVersion(req, res);
});
...
router.get('/list-table-objects', (req, res) => {
  void CPostgresV1.listTableObjects(req, res);
});
...
router.get('/diagram/schema', (req, res) => {
  void CPostgresV1.schemaDiagram(req, res);
});
router.get('/diagram/object/:tableName', (req, res) => {
  void CPostgresV1.objectDiagram(req, res);
});
